...
public class TimePick2 extends Activity implements View.OnClickListener {
    TextView tvInfo;
    Button butGetTime;
    Button btnSave;
    Button btnLoad;
        ...
        butGetTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tvInfo.setText(new StringBuilder()
                        ...
                        .append(Global.timepicker3.getCurrentHour()).append(":")
                        .append(Global.timepicker3.getCurrentMinute()));
            }
        });

        // Second TimePicker
        Global.timepicker3 = (TimePicker) findViewById(R.id.timePickerEnd);
        Global.timepicker3.setIs24HourView(true);
        Global.timepicker3.setCurrentHour(now.get(Calendar.HOUR_OF_DAY));
        Global.timepicker3.setCurrentMinute(now.get(Calendar.MINUTE));
        Global.timepicker3.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
    ...
    void saveText() {
        ...
        int hour2 = (Global.timepicker3.getCurrentHour());
        int minute2 = (Global.timepicker3.getCurrentMinute());
        ...
        editor.putString(Global.e_hours_2, String.valueOf(hour2));
        editor.putString(Global.e_minutes_2, String.valueOf(minute2));
        editor.putString(Global.GLOBAL_RESULT_2, String.valueOf(Global.mainresult));
        editor.commit();
        // Конец нового спрефа
