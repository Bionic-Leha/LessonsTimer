 ...
 */
public class TimePick7 extends Activity implements View.OnClickListener {
    TextView tvInfo;
    Button butGetTime;
    Button btnSave;
    Button btnLoad;
        ...
        butGetTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tvInfo.setText(new StringBuilder()
                        ...
                        .append(Global.timepicker8.getCurrentHour()).append(":")
                        .append(Global.timepicker8.getCurrentMinute()));
            }
        });

        // Second TimePicker
        Global.timepicker8 = (TimePicker) findViewById(R.id.timePickerEnd);
        Global.timepicker8.setIs24HourView(true);
        Global.timepicker8.setCurrentHour(now.get(Calendar.HOUR_OF_DAY));
        Global.timepicker8.setCurrentMinute(now.get(Calendar.MINUTE));
        Global.timepicker8.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
    ...
    void saveText() {
        ...
        int hour2 = (Global.timepicker8.getCurrentHour());
        int minute2 = (Global.timepicker8.getCurrentMinute());
        ...
        editor.putString(Global.e_hours_7, String.valueOf(hour2));
        editor.putString(Global.e_minutes_7, String.valueOf(minute2));
        editor.putString(Global.GLOBAL_RESULT_7, String.valueOf(Global.mainresult));
        editor.commit();
        // Конец нового спрефа
