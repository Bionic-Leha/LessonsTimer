...
public class TimePick3 extends Activity implements View.OnClickListener {
    TextView tvInfo;
    Button butGetTime;
    Button btnSave;
    Button btnLoad;
        ...
        butGetTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tvInfo.setText(new StringBuilder()
                        ...
                        .append(Global.timepicker4.getCurrentHour()).append(":")
                        .append(Global.timepicker4.getCurrentMinute()));
            }
        });

        // Second TimePicker
        Global.timepicker4 = (TimePicker) findViewById(R.id.timePickerEnd);
        Global.timepicker4.setIs24HourView(true);
        Global.timepicker4.setCurrentHour(now.get(Calendar.HOUR_OF_DAY));
        Global.timepicker4.setCurrentMinute(now.get(Calendar.MINUTE));
        Global.timepicker4.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
    ...
    void saveText() {
        ...
        int hour2 = (Global.timepicker4.getCurrentHour());
        int minute2 = (Global.timepicker4.getCurrentMinute());
        ...
        editor.putString(Global.e_hours_3, String.valueOf(hour2));
        editor.putString(Global.e_minutes_3, String.valueOf(minute2));
        editor.putString(Global.GLOBAL_RESULT_3, String.valueOf(Global.mainresult));
        editor.commit();
        // Конец нового спрефа
