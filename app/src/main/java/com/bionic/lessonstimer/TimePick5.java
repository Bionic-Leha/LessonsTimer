 ...
 */
public class TimePick5 extends Activity implements View.OnClickListener {
    TextView tvInfo;
    Button butGetTime;
    Button btnSave;
    Button btnLoad;
        ...
        butGetTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tvInfo.setText(new StringBuilder()
                        ...
                        .append(Global.timepicker6.getCurrentHour()).append(":")
                        .append(Global.timepicker6.getCurrentMinute()));
            }
        });

        // Second TimePicker
        Global.timepicker6 = (TimePicker) findViewById(R.id.timePickerEnd);
        Global.timepicker6.setIs24HourView(true);
        Global.timepicker6.setCurrentHour(now.get(Calendar.HOUR_OF_DAY));
        Global.timepicker6.setCurrentMinute(now.get(Calendar.MINUTE));
        Global.timepicker6.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
    ...
    void saveText() {
        ...
        int hour2 = (Global.timepicker6.getCurrentHour());
        int minute2 = (Global.timepicker6.getCurrentMinute());
        ...
        editor.putString(Global.e_hours_5, String.valueOf(hour2));
        editor.putString(Global.e_minutes_5, String.valueOf(minute2));
        editor.putString(Global.GLOBAL_RESULT_5, String.valueOf(Global.mainresult));
        editor.commit();
        // Конец нового спрефа
