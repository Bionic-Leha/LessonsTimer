 ...
 */
public class TimePick4 extends Activity implements View.OnClickListener {
    TextView tvInfo;
    Button butGetTime;
    Button btnSave;
    Button btnLoad;
        ...
        butGetTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tvInfo.setText(new StringBuilder()
                        ...
                        .append(Global.timepicker5.getCurrentHour()).append(":")
                        .append(Global.timepicker5.getCurrentMinute()));
            }
        });

        // Second TimePicker
        Global.timepicker5 = (TimePicker) findViewById(R.id.timePickerEnd);
        Global.timepicker5.setIs24HourView(true);
        Global.timepicker5.setCurrentHour(now.get(Calendar.HOUR_OF_DAY));
        Global.timepicker5.setCurrentMinute(now.get(Calendar.MINUTE));
        Global.timepicker5.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
    ...
    void saveText() {
        ...
        int hour2 = (Global.timepicker5.getCurrentHour());
        int minute2 = (Global.timepicker5.getCurrentMinute());
        ...
        editor.putString(Global.e_hours_4, String.valueOf(hour2));
        editor.putString(Global.e_minutes_4, String.valueOf(minute2));
        editor.putString(Global.GLOBAL_RESULT_4, String.valueOf(Global.mainresult));
        editor.commit();
        // Конец нового спрефа
